...
public class EmployeeAddressController {
	...
	public ResponseEntity<EmployeeAddress> modifyEmployeeAddressData(
			@RequestBody EmployeeAddress employeeAddressDto) throws Exception {
		System.out.println(employeeAddressDto.getEmpId());
		return ResponseEntity
				.ok(employeeAddressService.updateEmpAddressById(employeeAddressDto));
	}
}
